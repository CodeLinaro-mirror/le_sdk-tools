...
function qimsdk-target-get-updated-packages-all() {
    ...
    done < <(find ${QIMSDK_ESDK_BASE_DIR}/tmp/work/aarch64-oe-linux/ubuntu-base/20.04-r0/ubuntu_base_tmp/var/cache/apt/archives ${QIMSDK_ESDK_BASE_DIR}/tmp/deploy/${PKG_FORMAT}/ -type f \( -name "*gstreamer*.${PKG_FORMAT}" -o -name "libgst*.${PKG_FORMAT}" -o -name "*libgdk-pixbuf*.${PKG_FORMAT}" -o -name "*liborc*.${PKG_FORMAT}" -o -name "*libdaemon*.${PKG_FORMAT}" -o -name "*libgudev*.${PKG_FORMAT}" -o -name "*libjson-glib*.${PKG_FORMAT}" -o -name "*libmp3lame*.${PKG_FORMAT}" -o -name "*libpsl*.${PKG_FORMAT}" -o -name "*libtheora*.${PKG_FORMAT}" -o -name "*libtag*.${PKG_FORMAT}" -o -name "*libsoup*.${PKG_FORMAT}" -o -name "*libspeex1*.${PKG_FORMAT}" -o -name "mpg123*.${PKG_FORMAT}" \) -print0 )
    while IFS= read -r -d $'\0'; do
        UPDATED_PACKAGES+=("$REPLY")
...
function qimsdk-target-get-updated-packages-rel() {
    ...
    while IFS= read -r -d $'\0'; do
        UPDATED_PACKAGES+=("$REPLY")
    done < <(find ${QIMSDK_ESDK_BASE_DIR}/tmp/work/aarch64-oe-linux/ubuntu-base/20.04-r0/ubuntu_base_tmp/var/cache/apt/archives ${QIMSDK_ESDK_BASE_DIR}/tmp/deploy/${PKG_FORMAT}/ -type f \( -name "*gstreamer*.${PKG_FORMAT}" ! -iname "*gstreamer*-dev_*" ! -iname "*gstreamer*-staticdev_*" ! -iname "*gstreamer*-doc_*" ! -iname "*gstreamer*-dbg_*" ! -iname "*gstreamer*-src_*" ! -iname "*gstreamer*-locale-*" -o -name "libgst*.${PKG_FORMAT}" -o -name "*libgdk-pixbuf-2.0-0_*.${PKG_FORMAT}" -o -name "*liborc*.${PKG_FORMAT}" ! -iname "*liborc*-test-*" -o -name "*libdaemon*.${PKG_FORMAT}" ! -iname "*libdaemon*-dev_*" ! -iname "*libdaemon*-staticdev_*" ! -iname "*libdaemon*-doc_*" ! -iname "*libdaemon*-dbg_*" ! -iname "*libdaemon*-src_*" -o -name "*libgudev*.${PKG_FORMAT}" ! -iname "*libgudev*-dev_*" ! -iname "*libgudev*-dbg_*" ! -iname "*libgudev*-src_*" -o -name "*libjson-glib*.${PKG_FORMAT}" ! -iname "*libjson-glib*-bin_*" ! -iname "*libjson-glib*-dev_*" ! -iname "*libjson-glib*-dbg_*" ! -iname "*libjson-glib*-locale-*" -o -name "*libmp3lame*.${PKG_FORMAT}" ! -iname "*libmp3lame*-dev_*" -o -name "*libpsl*.${PKG_FORMAT}" ! -iname "*libpsl*-bin_*" ! -iname "*libpsl*-dev_*" ! -iname "*libpsl*-staticdev_*" ! -iname "*libpsl*-doc_*" ! -iname "*libpsl*-dbg_*" ! -iname "*libpsl*-src_*" -o -name "*libtheora*.${PKG_FORMAT}" ! -iname "*libtheora*-dev_*" ! -iname "*libtheora*-staticdev_*" ! -iname "*libtheora*-dbg_*" ! -iname "*libtheora*-src_*" -o -name "*libtag*.${PKG_FORMAT}" ! -iname "*libtag*-c0_*" ! -iname "*libtag*-dev_*" ! -iname "*libtag*-dbg_*" -o -name "*libsoup*.${PKG_FORMAT}" ! -iname "*libsoup*-dev_*" ! -iname "*libsoup*-dbg_*" ! -iname "*libsoup*-src_*" ! -iname "*libsoup*-locale-*" -o -name "*libspeex1*.${PKG_FORMAT}" ! -iname "*libspeex1*-dev_*" ! -iname "*libspeex1*-staticdev_*" ! -iname "*libspeex1*-doc_*" ! -iname "*libspeex1*-dbg_*" -o -name "mpg123*.${PKG_FORMAT}" ! -iname "*mpg123*-dev_*" ! -iname "*mpg123*-doc_*" ! -iname "*mpg123*-dbg_*" ! -iname "*mpg123*-src_*" \) -print0 )
    while IFS= read -r -d $'\0'; do
        UPDATED_PACKAGES+=("$REPLY")
    done < <(find ${QIMSDK_ESDK_BASE_DIR}/tmp/work/aarch64-oe-linux/ubuntu-base/20.04-r0/ubuntu_base_tmp/var/cache/apt/archives ${QIMSDK_ESDK_BASE_DIR}/tmp/deploy/${PKG_FORMAT}/ -type f \( -name "*.${PKG_FORMAT}" ! -iname "libspeexdsp1*.${PKG_FORMAT}" ! -iname "qnn*.${PKG_FORMAT}" ! -iname "snpe*.${PKG_FORMAT}" ! -iname "tensorflow*.${PKG_FORMAT}" ! -iname  "rsvg*.${PKG_FORMAT}" ! -iname "*gstreamer*.${PKG_FORMAT}" ! -iname "*-dev_*" ! -iname "*-staticdev_*" ! -iname "*-doc_*" ! -iname "*-dbg_*" ! -iname "*-src_*" ! -iname "*-gtk_*" ! -iname "*-bin_*" ! -iname "*-locale-*" \) -cnewer ${QIMSDK_WORK_DIR}/prepared -print0)
}
...
function qimsdk-target-get-updated-packages-dbg() {
    ...
    while IFS= read -r -d $'\0'; do
        UPDATED_PACKAGES+=("$REPLY")
    done < <(find ${QIMSDK_ESDK_BASE_DIR}/tmp/work/aarch64-oe-linux/ubuntu-base/20.04-r0/ubuntu_base_tmp/var/cache/apt/archives ${QIMSDK_ESDK_BASE_DIR}/tmp/deploy/${PKG_FORMAT}/ -type f \( -name "*gstreamer*-dbg_*.${PKG_FORMAT}" ! -iname "*gstreamer*-dev_*" ! -iname "*gstreamer*-staticdev_*" ! -iname "*gstreamer*-doc_*" -o -name "*libgdk-pixbuf-*-dbg_*.${PKG_FORMAT}" -o -name "*libdaemon*-dbg_*.${PKG_FORMAT}" -o -name "*libgudev*-dbg_*.${PKG_FORMAT}" -o -name "*libjson-glib*-dbg_*.${PKG_FORMAT}" -o -name "*libpsl*-dbg_*.${PKG_FORMAT}" -o -name "*libtheora*-dbg_*.${PKG_FORMAT}" -o -name "*libtag*-dbg_*.${PKG_FORMAT}" -o -name "*libsoup*-dbg_*.${PKG_FORMAT}" -o -name "*libspeex1*-dbg_*.${PKG_FORMAT}" -o -name "mpg123*-dbg_*.${PKG_FORMAT}" \) -print0 )
    while IFS= read -r -d $'\0'; do
        UPDATED_PACKAGES+=("$REPLY")
    done < <(find ${QIMSDK_ESDK_BASE_DIR}/tmp/work/aarch64-oe-linux/ubuntu-base/20.04-r0/ubuntu_base_tmp/var/cache/apt/archives ${QIMSDK_ESDK_BASE_DIR}/tmp/deploy/${PKG_FORMAT}/ -type f \( -name "*-dbg_*.${PKG_FORMAT}" ! -iname "qnn*.${PKG_FORMAT}" ! -iname "snpe*-dbg_*.${PKG_FORMAT}" ! -iname "tensorflow*.${PKG_FORMAT}" ! -iname  "*gstreamer*.${PKG_FORMAT}" ! -iname "*-dev_*" ! -iname "*-staticdev_*" ! -iname "*-doc_*" \) -cnewer ${QIMSDK_WORK_DIR}/prepared -print0)
}
...
function qimsdk-target-get-updated-packages-dev() {
    ...
    while IFS= read -r -d $'\0'; do
        UPDATED_PACKAGES+=("$REPLY")
    done < <(find ${QIMSDK_ESDK_BASE_DIR}/tmp/work/aarch64-oe-linux/ubuntu-base/20.04-r0/ubuntu_base_tmp/var/cache/apt/archives ${QIMSDK_ESDK_BASE_DIR}/tmp/deploy/${PKG_FORMAT}/ -type f \( -name "*gstreamer*-dev_*.${PKG_FORMAT}" ! -iname "*gstreamer*-staticdev_*" ! -iname "*gstreamer*-doc_*" ! -iname "*gstreamer*-dbg_*" -o -name "*libgdk-pixbuf-*-dev_*.${PKG_FORMAT}" -o -name "*libdaemon*-dev_*.${PKG_FORMAT}" -o -name "*libgudev*-dev_*.${PKG_FORMAT}" -o -name "*libjson-glib*-dev_*.${PKG_FORMAT}" -o -name "*libmp3lame-dev_**.${PKG_FORMAT}" -o -name "*libpsl*-dev_*.${PKG_FORMAT}" -o -name "*libtheora*-dev_*.${PKG_FORMAT}" -o -name "*libtag*-dev_*.${PKG_FORMAT}" -o -name "*libsoup*-dev_*.${PKG_FORMAT}" -o -name "*libspeex1*-dev_*.${PKG_FORMAT}" -o -name "mpg123*-dev_*.${PKG_FORMAT}" \) -print0 )
    while IFS= read -r -d $'\0'; do
        UPDATED_PACKAGES+=("$REPLY")
    done < <(find ${QIMSDK_ESDK_BASE_DIR}/tmp/work/aarch64-oe-linux/ubuntu-base/20.04-r0/ubuntu_base_tmp/var/cache/apt/archives ${QIMSDK_ESDK_BASE_DIR}/tmp/deploy/${PKG_FORMAT}/ -type f \( -name "*-dev_*.${PKG_FORMAT}" ! -iname "qnn*.${PKG_FORMAT}" ! -iname "snpe*-dev_*.${PKG_FORMAT}" ! -iname "tensorflow*.${PKG_FORMAT}" ! -iname  "*gstreamer*.${PKG_FORMAT}" ! -iname "*-dbg_*" ! -iname "*-staticdev_*" ! -iname "*-doc_*" \) -cnewer ${QIMSDK_WORK_DIR}/prepared -print0)
}
