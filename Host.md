...
* 10. ***MANDATORY*** - **Device_install_prefix** - Prefix to be prepended to the package installation path on target device - Installing packages in / directory is forbidden. Do not leave field empty, or set / value !!! (e.g. choosing /data/sdk would install gst libs in /data/sdk/usr/lib/gstreamer-1.0)
