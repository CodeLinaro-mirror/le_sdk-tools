...
The json file must contain certain data :
 ...
 5. ***OPTIONAL*** - **Tflite_path** - Path to the directory where the prebuilt tflite dev archive is located ***PATH MUST BE ABSOLUTE, DO NOT USE A RELATIVE PATH!***
...
### Please note that if tflite prebuilt archive is not provided, tflite functions will not work!
